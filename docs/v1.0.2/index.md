...
Welcome to [FLIM Imager](https://github.com/flim-labs/flim-imager-releases) _v1.0.2_ usage guide. In this documentation section, you will find all the necessary information for the proper use of the application.
