...
Welcome to [FLIM Imager](https://github.com/flim-labs/flim-imager-releases) _v1.0.4_ usage guide. In this documentation section, you will find all the necessary information for the proper use of the application.
...
#### FLIM Phasors Mode
<div align="center">
    <img src="../assets/images/flim-phasors-mode-v1.0.2.png" alt="GUI v1.0" width="100%">
</div>
...
#### Settings
<div align="center">
    <img src="../assets/images/settings-v1.0.4.png" alt="GUI v1.0" width="100%">
</div>
...
**100ps** (pico mode): when enabled, acquisition switches to the dedicated 80 MHz / 100 ps firmware and timing map, providing 100-picosecond resolution for phase and per-channel bin extraction. This option is available only when the selected or nearest laser frequency is 80 MHz; enabling forces the pico firmware for image capture, disabling reverts to the standard 80 MHz firmware.
...
| **dwellTime**  | Pixel dwell time in microseconds  | number  | required only to calculate CPS and in LF/F modes  |
