...
Welcome to [FLIM Imager](https://github.com/flim-labs/flim-imager-releases) _v1.0.3_ usage guide. In this documentation section, you will find all the necessary information for the proper use of the application.
...
#### Settings
<div align="center">
    <img src="../assets/images/settings-v1.0.3.png" alt="GUI v1.0" width="100%">
</div>
